...
class OutcomeTermPolicyTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_active_tenant_admin_can_manage_effective_version_terms(): void
    {
        ...
        $this->assertTrue($admin->can('viewAny', OutcomeTerm::class));
        $this->assertTrue($admin->can('view', $term));
        $this->assertTrue($admin->can('create', OutcomeTerm::class));
    ...
    public function test_deactivated_tenant_admin_cannot_manage_terms(): void
    {
        ...
        $this->assertFalse($admin->can('viewAny', OutcomeTerm::class));
        $this->assertFalse($admin->can('view', $term));
        $this->assertFalse($admin->can('create', OutcomeTerm::class));
    ...
    public function test_non_admin_roles_cannot_manage_terms(Role $role): void
    {
        ...
        $this->assertFalse($user->can('viewAny', OutcomeTerm::class));
        $this->assertFalse($user->can('view', $term));
        $this->assertFalse($user->can('create', OutcomeTerm::class));
