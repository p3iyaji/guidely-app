...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(NeedTerm::class, NeedTermPolicy::class);
        Gate::policy(OutcomeTerm::class, OutcomeTermPolicy::class);
        Gate::policy(ProvisionTerm::class, ProvisionTermPolicy::class);
        Gate::policy(Pupil::class, PupilPolicy::class);
        Gate::policy(RelationshipMapping::class, RelationshipMappingPolicy::class);
        Gate::policy(SafeguardingSignal::class, SafeguardingSignalPolicy::class);
        Gate::policy(SettingTerm::class, SettingTermPolicy::class);
        Gate::policy(Tenant::class, TenantPolicy::class);
        Gate::policy(ThresholdTerm::class, ThresholdTermPolicy::class);
        ...
        Gate::policy(DashboardSummary::class, DashboardSummaryPolicy::class);
